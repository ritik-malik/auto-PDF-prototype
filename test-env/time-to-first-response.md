...
![GrimoireLab Panel: Efficiency Timing Overview](images/efficiency_timing_overview.png)
![Augur Visualization: Time to First Response Heat Map ](images/augur-ttc-1.png)
![Augur Visualization: Mean Response Times](images/augur-ttc-2.png)
